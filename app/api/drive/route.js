...
/** El refresh token no vence: se cambia por un access token cada vez. */
async function accessToken() {
  ...
  if (!j.access_token) throw new Error("Google no dio el token: " + (j.error_description || j.error || "sin detalle"));
